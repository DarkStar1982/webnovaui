        ...
        case 'uncompleted':
          ...
          switch (object.download_link)
          {
            case 'Not available yet':
              ...
              $('<td>').html("<strong>$999.95</strong>").appendTo(row);
              $('<td>').html('<button class=btn onclick="update_mission('+object.id+')">Purchase</a></button>').appendTo(row);
              row.appendTo(tableBody);
              break;
          }
          break;
        case 'completed':
          var tableBody = $('#mission_list2_table tbody');
